...
If ADCS is installed, try [shadow credentials]({{< relref "10. Lateral Movement/ADCS attacks#shadow-credentials" >}}) first
# Kerberoast
...
> NOTE: See [10. Lateral Movement/Enumeration#Writable Objects]({{< relref "10. Lateral Movement/Enumeration#writable-objects" >}}). If we can write to `UserAccountControl` then we can enable the account
