...
First, let's change the UPN of a user that we can write to. See [8. Lateral Movement/AD Enumeration/Get All Properties#Writable Objects]({{< relref "8. Lateral Movement/AD Enumeration/Get All Properties#writable-objects" >}})
